...
AutoDesk's AEC (Architecture, Engineering, and Construction) vertical earned $358M in the last quarter of 2019, but [their current product mix](https://www.autodesk.com/collections/architecture-engineering-construction/overview) is not quite comparable to ProCore's.

From AutoDesk's 10-Q 2019 (Ending 10/2019):
![autocad_aec_2019]({{ site.url }}/assets/procore/autocad_aec_2019.png)
...
(The table of comparable net retention rates below is from a [2019 Blossom Ventures post](https://blossomstreetventures.com/2019/06/24/net-vs-gross-dollar-retention-stats/))
...
2018:
```PCOR (using revenue growth and operating margin): 66% + (-30) = ~36```
...
[Most SAAS companies](https://carta.com/blog/saas-company-valuations-ipo-alex-clayton/) are valued on multiples over next twelve months (NTM) revenue.

**NTM Revenue Multiples for ProCore**

From [Meritech Capital's post](https://www.meritechcapital.com/blog/procore-ipo-s-1-breakdown):

![valuation]({{ site.url }}/assets/procore/valuation.png)
 
# Verdict

ProCore has a great headstart in an industry that has significant barriers to entry. 
Moreover, they are making good progress to being the system of record for the construction industry, and has great potential to be a platform company.
